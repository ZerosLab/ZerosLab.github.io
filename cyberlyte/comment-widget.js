...
const s_formId = '1FAIpQLSfxl1gFGpVdvQL6PPqfUpu55H0Sbu1J0vZr9yRyHWDRXTotTw'; // The Google Form
const s_nameId = '2102516933'; // The Name field ID
const s_websiteId = '754517319'; // The Website field ID
const s_textId = '403896924'; // The Text field ID
const s_pageId = '1026256102'; // The Page field ID
const s_replyId = '1761687768'; // The Reply field ID
const s_sheetId = '1T3OP_O8MYkBilqPbFgb-606noM3kb8_MZnvzjvJqwyM'; // The Google Sheet
...
const s_includeUrlParameters = true; // Makes new comment sections on pages with URL parameters when set to true (If you don't know what this does, leave it disabled)
