...
red = getRandomIntInclusive(0,2)*128;
green = getRandomIntInclusive(0,2)*128;
blue = getRandomIntInclusive(0,2)*128;
...
function testColor(form){
	var redguess = form.Red.value*128;
  if (redguess == 256){
  	redguess = 255;
  }
	var greenguess = form.Green.value*128;
  if (greenguess == 256){
  	greenguess = 255;
  }
	var blueguess = form.Blue.value*128;
  if (blueguess == 256){
  	blueguess = 255;
  }
